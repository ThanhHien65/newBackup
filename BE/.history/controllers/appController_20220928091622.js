          ...
          if (bresult === true) {
            ...
            Backup.statusBackupday((backupday, err) => {
              Backup.statusASPBackupday((aspbackup, err) => {
                res
                  .status(200)
                  .send({ msg: "Logged in!", token, backupday, aspbackup });
              });
            });
            console.log(
              parseIp(req),
...
exports.Listimage = (req, res) => {
  const directoryPath = "/home/hanbiro/OFF/OffGW_30082022-14:46.png";
  ...
  //   });
  // });
  res.status(200).sendFile(directoryPath + "OffGW_30082022-14:46.png");
  console.log(
    parseIp(req),
    `${moment().format("YYYY-MM-ddd HH:mm:ss")} ||`,
    `[GET-STATUS-IMAGE]`
