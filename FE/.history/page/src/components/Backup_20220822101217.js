...
const Backup = () => {
  ...
  const confirm = () => {
    ...
    const checked = () => {
      axios
        .put("http://localhost:5000/checked", {
          id: aBackup[0].id,
        })
  ...
  return (
    <div className="container_content">
      <div className="content_table">
        <table>
          <tr>
            <th onClick={() => console.log(BackupDaily, Test, diskASPBackup)}>
              #
            </th>
            <th>hostname</th>
            <th>ipaddress</th>
