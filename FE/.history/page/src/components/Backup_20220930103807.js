              ...
              <div className="statusinfo">
                ...
                {item.fvalue == 0 ? (
                  <h1>
                    ...
                    {item.status_filebackup.length > 25
                      ? `STATUS : ${item.status_filebackup}`
                      : ""}
                  </h1>
                ) : item.fvalue == null ? (
                  ""
                ...
                {item.bvalue == 0 ? (
                  <h1>
                    BIGDATA : not Checked <br />
                    {item.status.status_bigdata.length > 25
                      ? `STATUS : ${item.status.status_bigdata}`
                      : ""}
                  </h1>
                ) : item.bvalue == null ? (
                  ""
